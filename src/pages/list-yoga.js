        ...
        setTimeout(() => {
            api.getYoga({
                ...
                success: (items) => {
                    ...
                    app.$content_list_yoga.html(yogalist({
                        items:items
                    }));

                    var complete_items = 0;

                    page.list_items = document.querySelectorAll('#content-list-yoga .itemlist-media');
                        ...
                        api.getItem(image.dataset.id,{
                            ...
                            complete: () => {
                                ...
                                if(onComplete !== undefined) {
                                    onComplete(complete_items, page.list_items.length);
                                }
